...
public class PlayForceCmd extends MusicCommand
{
    ...
    public void doCommand(CommandEvent event)
    {
        ...
        event.reply(loadingEmoji+" Loading... `["+args+"]`", m -> bot.getNoYtPlayerManager().loadItemOrdered(event.getGuild(), args, new ResultHandler(m,event,false)));
    }
